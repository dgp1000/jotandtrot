...
5. **Richer collaboration** — comments on stops ✅ built 8 Aug 2026 (💬 on every stop card, realtime-synced trip_comments table, delete own/owner). Date polling ✅ built 8 Aug 2026 (undated trips get a poll banner; propose date windows, vote ✅/🤷/❌ with live counts and a ⭐ leader, one tap applies the winner to the trip). Still open: task assignments, notes/links/photos per stop.
