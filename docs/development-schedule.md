...
5. **Richer collaboration** — comments on stops ✅ built 8 Aug 2026 (💬 on every stop card, realtime-synced trip_comments table, delete own/owner). Still open: date polling ("when can everyone go?"), task assignments, notes/links/photos per stop.
